...
class SpkHppController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if($request->ajax()){
            ...
            ->addColumn('action', function($data){
                $button = '<a href="'.url('spk-hpp').'/detail/'.$data->id.'" class="btn btn-outline-info btn-sm">Check Gross Margin</a>';
                $button .= '&nbsp;&nbsp;';
                return $button;
            })
            ->rawColumns(['action'])
        ...
        return view('spk-hpp',compact('menu'));
    }
    ...
    public function detail(Request $request,$id)
    {
        ...
        return view('margin-spk-hpp',compact('menu','id','estimates','jasa','part','totaljasa','totalpart','totalqty_s','totalqty_p','totalprice_s','totalprice_p'));
    }
}
