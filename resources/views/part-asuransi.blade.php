...
<p class="section-lead">Data SPK Asuransi Spare Part</p>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="price_p" name="price_p" min="0" value=""
                                            required disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="qty" class="col-sm-12 control-label">Harga After Markup</label>
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="after" name="after" min="0" value=""
                                            required disabled>
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#users-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'price_asuransi_p',
                        name: 'price_asuransi_p',
                        render: function (data, type, row, meta) {
                            return meta.settings.fnFormatNumber(row.price_asuransi_p);
                        }
                    },
                    {
                        data: 'subtotal',
                    ...
                    {
                        data: 'diskon_asuransi_p',
                        name: 'diskon',
                        render: function (data, type, row, meta) {
                            return meta.settings.fnFormatNumber(row.diskon_asuransi_p);
                        }
                    },
                    {
                        data: 'netto',
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('../../part/' + data_id + '/edit', function (data) {
                ...
                $('#price').val(data.price_asuransi_p);
                $('#diskon').val(data.diskon_asuransi_p);
