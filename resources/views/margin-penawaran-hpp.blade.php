            ...
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th colspan="4">%</th>
                            <th>@php if($margin_part_ppn > 0){echo round(($margin_part_ppn / $sum_after_p)* 100)."%";  }@endphp</th>
                            <th>@php if($margin_jasa_ppn > 0){echo round(($margin_jasa_ppn / $sum_after_s)* 100)."%";  }@endphp</th>
