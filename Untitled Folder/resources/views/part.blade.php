                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="number" class="form-control" id="markup_p" name="markup_p" min="0" value=""
                                            required>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <label for="qty" class="col-sm-12 control-label">Mark Up(%)</label>
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" id="markup_s" name="markup_s" min="0" value=""
                                        required>
                                </div>
                            </div>
                            <div class="col-sm-offset-2 col-sm-12">
