...
@section('title')
Check Gross Margin - Penawaran vs HPP
@endsection
@push('link-asset')
...
@endsection
@section('content')
<h2 class="section-title">Check Gross Margin - Penawaran vs HPP</h2>
    ...
    <div class="section-body">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                @endif
                <h4><span class="badge badge-dark">Gross Margin - Penawaran vs HPP</span></h4>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        $total_penawaran = $sum_after_p + $sum_after_s;
                        @endphp
                        @endforeach
                        @php
                        $part_dpp = $sum_after_p / 1.1;  
                        $jasa_dpp = $sum_after_s / 1.1;  
                        $total_dpp = $total_penawaran / 1.1;
                        ...
                        $margin_part_ppn = $sum_after_p - $part_ppn;
                        $margin_jasa_ppn = $sum_after_s - $jasa_ppn;
                        $margin_total_ppn = $total_penawaran - $total_ppn;
                        @endphp
                        <tr>
                            <th>DPP</th>
                        ...
                        <tr>
                            <th colspan="4">%</th>
                            <th>@php echo round(($margin_part_dpp / $part_dpp)* 100)."%";  @endphp</th>
                            <th>@php echo round(($margin_jasa_dpp / $jasa_dpp)* 100)."%";  @endphp</th>
                        ...
                        <tr>
                            ...
                            <th>{{ "Rp.".number_format($sum_after_p,0,',','.')}}</th>
                            <th>{{ "Rp.".number_format($sum_after_s,0,',','.')}}</th>
                            <th>{{ "Rp.".number_format($total_penawaran,0,',','.')}}</th>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th colspan="4">%</th>
                            <th>@php echo round(($margin_part_ppn / $sum_after_p)* 100)."%";  @endphp</th>
                            <th>@php echo round(($margin_jasa_ppn / $sum_after_s)* 100)."%";  @endphp</th>
                            <th>{{ round(($margin_total_ppn / $total_penawaran)* 100)."%"  }}</th>
                        </tr>
                    </tbody>
                </table>
