...
<p class="section-lead">Data HPP Sparepart & Jasa</p>
                ...
                <table class="table table-striped table-bordered table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ "Rp.".number_format($j->price_dpp,0,',','.') }}</td>
                            <td>{{ number_format($j->diskon_dpp_p,0,',','.')."%" }}</td>
                            <td>{{ "Rp.".number_format($j->netto,0,',','.') }}</td>
                            <td>{{ "Rp.".number_format($j->subtotal_dpp,0,',','.') }}</td>
                            <td>{{ number_format($j->markup_p,0,',','.')."%" }}</td>
                ...
                <table  class="table table-striped table-bordered table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ "Rp.".number_format($i->price_dpp,0,',','.') }}</td>
                            <td>{{ number_format($i->diskon_dpp_s,0,',','.')."%" }}</td>
                            <td>{{ "Rp.".number_format($i->netto,0,',','.') }}</td>
                            <td>{{ "Rp.".number_format($i->subtotal_dpp,0,',','.') }}</td>
                            <td>{{ number_format($i->markup_s,0,',','.')."%" }}</td>
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('logistik.create') }}", //url simpan data
