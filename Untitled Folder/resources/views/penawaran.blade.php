...
<div class="section-body">
    ...
    <div class="modal fade" id="tambah-edit-modal" aria-hidden="true">
        <div class="modal-dialog ">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-tambah-edit" name="form-tambah-edit" class="form-horizontal" action="{{ url('penawaran/cetak') }}">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="asuransi" class="col-sm-12 control-label">Kepada:</label>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label for="nopol" class="col-sm-12 control-label">Nama Pengirim:</label>
                                    <div class="col-sm-12">
 ...
 //SIMPAN & UPDATE DATA DAN VALIDASI (SISI CLIENT)
        ...
        //                 url: "{{ route('penawaran.store') }}", //url simpan data
 ...
 //TOMBOL EDIT DATA PER PEGAWAI DAN TAMPIKAN DATA BERDASARKAN ID PEGAWAI KE MODAL
        ...
        $('body').on('click', '.edit-post', function () {
            ...
            $.get('penawaran/' + data_id + '/edit', function (data) {
                $('#modal-judul').html("Cetak Penawaran");
